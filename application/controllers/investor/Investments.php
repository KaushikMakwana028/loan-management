...
class Investments extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $sql = "SELECT li.*, l.amount as loan_amount, l.tenure_days, IF(l.investor_interest_rate > 0, l.investor_interest_rate, l.interest_rate) as interest_rate, l.is_emi, l.emi_count, l.status as loan_status, u.name as borrower_name 
