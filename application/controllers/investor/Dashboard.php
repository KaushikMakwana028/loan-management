...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $sql_opportunities = "SELECT n.*, l.amount as loan_amount, l.tenure_days, IF(l.investor_interest_rate > 0, l.investor_interest_rate, l.interest_rate) as interest_rate, l.is_emi, l.emi_count, u.name as borrower_name 
        ...
        $sql_recent_invests = "SELECT li.*, l.amount as loan_amount, l.tenure_days, IF(l.investor_interest_rate > 0, l.investor_interest_rate, l.interest_rate) as interest_rate, l.is_emi, l.emi_count, l.status as loan_status, u.name as borrower_name 
