            ...
            <tbody>
                <?php if (!empty($requests)): ?>
                    ...
                    <?php foreach ($requests as $req): ?>
                        <?php
                        $initials = strtoupper(substr($req->investor_name, 0, 1));
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="wr-investor">
                                    ...
                                    <div>
                                        <div class="wr-investor-name"><?php echo html_escape($req->investor_name); ?></div>
                                        <div class="wr-investor-email"><?php echo html_escape($req->investor_email); ?></div>
                                    </div>
                                </div>
                            </td>
    ...
    function approveRequest(id, isDisabled) {
        if (isDisabled) {
            Swal.fire({
                ...
                text: 'This investor does not have enough balance in their wallet to process this withdrawal.'
            });
            return;
        }
        ...
        Swal.fire({
            ...
            text: 'Are you sure you want to approve this withdrawal request? This will deduct the amount from the investor\'s wallet balance.',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                window.location.href = `<?php echo base_url('admin/withdrawal_requests/approve/'); ?>${id}`;
            }
        });
    }
    ...
    function rejectRequest(id) {
        Swal.fire({
            ...
            preConfirm: (note) => {
                ...
                form.method = 'POST';
                form.action = `<?php echo base_url('admin/withdrawal_requests/reject/'); ?>${id}`;
