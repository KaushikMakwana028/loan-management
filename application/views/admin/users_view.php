<style>
    ...
    @media (max-width: 768px) {
        ...
        /* Label each cell using data-label (added in the PHP loop below) */
        tbody tr td::before {
        ...
        /* Sr No + Name become a compact header row inside the card */
        tbody tr td[data-label="Sr. No."] {
            display: none;
            /* not essential on mobile, hide to save space */
        }
        ...
        tbody tr td[data-label="Name"] strong {
            width: 100%;
            text-align: left;
        }
                ...
                <?php if (!empty($users)): ?>
                    ...
                    <?php foreach ($users as $usr): ?>
                        ...
                        <tr>
                            ...
                            <td data-label="Name"><strong><?php echo html_escape($usr['name']); ?></strong></td>
                            <td data-label="Contact Info">
                                <?php echo html_escape($usr['mobile']); ?>
                                <br>
                                <span style="font-size: 12px; color: #65758b;"><?php echo html_escape($usr['email'] ?: '-'); ?></span>
                            </td>
                            <td data-label="Address"><?php echo html_escape($usr['address'] ?: '-'); ?></td>
