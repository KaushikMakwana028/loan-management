...
<head>
    ...
    <style>
        *{box-sizing:border-box;font-family:'Poppins',sans-serif;}
        body{margin:0;min-height:100vh;background:#f4f7fb;color:#182033;display:grid;place-items:center;padding:24px;}
        .wrap{width:100%;max-width:480px;background:#fff;border-radius:24px;padding:34px;box-shadow:0 24px 70px rgba(22,34,51,.12);}
        ...
        input{width:100%;border:1px solid #dbe3ef;border-radius:12px;padding:13px 14px;font-size:15px;outline:none;background:#fff;}
        input:focus{border-color:#0f766e;box-shadow:0 0 0 4px rgba(15,118,110,.12);}
        .btn{width:100%;border:0;border-radius:12px;background:#0f766e;color:#fff;padding:14px 22px;font-weight:700;font-size:15px;cursor:pointer;}
