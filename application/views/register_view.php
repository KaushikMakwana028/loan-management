    ...
    <style>
        ...
        * {
        ...
        body {
            margin: 0;
            min-height: 100vh;
            background: radial-gradient(circle at 0 0, rgba(6, 61, 50, .14), transparent 30%), radial-gradient(circle at 100% 5%, rgba(197, 155, 39, .14), transparent 28%), var(--bg);
            color: var(--ink);
        }
        ...
        <section class="card">
            <div class="brand">
                <a class="brand-left" href="<?php echo base_url(); ?>">
                    <img src="<?php echo base_url('assets/images/logo/bg-remove-sidelogo.png'); ?>" alt="Logo" style="height: 44px; width: auto; object-fit: contain;">
                </a>
            ...
            <?php echo form_open('user/register-user'); ?>
            <div class="field">
                <label>Name</label>
