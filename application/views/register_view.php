...
<head>
    ...
    <title>User Register | Loan Management</title>
    ...
    <style>
        ...
        * { box-sizing:border-box; font-family:'Plus Jakarta Sans', sans-serif; }
        body { margin:0; min-height:100vh; background:radial-gradient(circle at 0 0, rgba(15,118,110,.14), transparent 30%), radial-gradient(circle at 100% 5%, rgba(37,99,235,.12), transparent 28%), var(--bg); color:var(--ink); }
        ...
        .mark { width:42px; height:42px; border-radius:15px; display:grid; place-items:center; background:linear-gradient(135deg,var(--primary),#12b3a5); color:#fff; box-shadow:0 18px 32px rgba(15,118,110,.22); }
        .login-link { color:var(--primary); font-weight:800; font-size:14px; }
        .pill { display:inline-flex; border:1px solid #b9ebe4; border-radius:999px; background:#ecfdf5; color:var(--primary); padding:7px 12px; font-size:12px; font-weight:800; margin-bottom:16px; }
        ...
        .btn { width:100%; min-height:52px; border:0; border-radius:16px; background:linear-gradient(135deg,var(--primary),#12a998); color:#fff; font-size:15px; font-weight:800; cursor:pointer; box-shadow:0 18px 34px rgba(15,118,110,.22); margin-top:4px; }
...
<body>
    <main class="auth-wrap">
        <section class="card">
            <div class="brand">
                <a class="brand-left" href="<?php echo base_url(); ?>"><span class="mark">LM</span><span>Loan Mitra</span></a>
