...
$req_fields = ['name', 'mobile', 'email', 'address', 'aadhaar_number', 'pan_number', 'account_holder_name', 'bank_name', 'account_number', 'ifsc_code', 'account_type', 'branch_name'];
$filled = 0;
...
<style>
    ...
    .pf-head {
        ...
        border-radius: 24px;
        overflow: hidden;
        background: linear-gradient(135deg, var(--pf-teal) 0%, #a855f7 100%);
...
<div class="pf-wrap">
    ...
    <section class="pf-head">
        <div class="pf-head-top">
            <div>
                ...
                <p>Complete every section below to keep your investor account fully verified.</p>
            </div>
    ...
    <!-- ============ Form ============ -->
    <?php echo form_open_multipart('investor/profile/update', ['class' => 'pf-form', 'id' => 'pfForm']); ?>
    <div class="pf-grid">
